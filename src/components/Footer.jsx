        ...
        <div className="bg-base-200 font-inter">
            <div className="md:container md:mx-auto 2xl:px-0 xl:px-0 lg:px-5 md:px-5 px-5">
                <footer className="footer py-10 text-base-content">
                    <nav>
                        <header className="text-xl text-black font-medium">Keep In Touch</header>
                        <a className="link link-hover">165 Green Road , Dhaka 1205</a>
                        <a className="link link-hover">+8801755212509</a>
                        <a className="link link-hover">info@aayojan.com</a>
                    </nav>
                    <nav>
                        <header className="text-xl text-black font-medium">Company</header>
                        <a className="link link-hover">About us</a>
                        <a className="link link-hover">Contact</a>
                        <a className="link link-hover">Jobs</a>
                    </nav>
                    <nav>
                        <header className="text-xl text-black font-medium">Legal</header>
                ...
                <footer className="footer py-4 border-t text-base-content border-base-300">
                    <aside className="items-center grid-flow-col gap-5">
                        ...
                        <p className="text-base"><span className="font-semibold">Aayojan<sup>&reg;</sup></span><br />Providing full range of Events Management since 2024</p>
                    </aside>
